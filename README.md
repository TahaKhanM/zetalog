...
- **Strict TypeScript** (`noUncheckedIndexedAccess`, `exactOptionalPropertyTypes`), zero-warning
  ...
  every commit.
- **Pure domain core:** all scoring and anti-abuse logic is deterministic, dependency-injected and property-tested; `packages/shared` enforces 100% branch coverage in CI.
